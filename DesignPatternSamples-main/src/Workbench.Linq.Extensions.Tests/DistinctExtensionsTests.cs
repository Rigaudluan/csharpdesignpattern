...
namespace Workbench.Linq.Extensions.Tests
{
    public class DistinctExtensionsTests
    {
        ...
        public void ListagemComItensRepetidosComparecaoSimples()
        {
            ...
            {
                new PessoaFisica() { Nome = "Maria", NomeMae = "asd", CPF = "111.111.111-11" },
                new PessoaFisica() { Nome = "Marcos", NomeMae = "ad", CPF = "111.111.111-11" },
                new PessoaFisica() { Nome = "fernando", NomeMae = "fe", CPF = "222.222.222-22" }
            };
            ...
            Assert.DoesNotContain(pessoasDiferentes, p => p.NomeMae == "ad");
        }
